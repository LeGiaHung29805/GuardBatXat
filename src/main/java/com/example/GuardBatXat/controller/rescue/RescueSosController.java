package com.example.GuardBatXat.controller.rescue;
...
@RestController("rescueSosControllerV1")
...
public class RescueSosController {
    ...
    public ResponseEntity<ApiResponse<List<com.example.GuardBatXat.dto.response.rescue.SosUpdateLogResponse>>> getSosUpdates(@PathVariable Integer id) {
        List<com.example.GuardBatXat.dto.response.rescue.SosUpdateLogResponse> data = sosService.getSosUpdates(id);
    ...
    public ResponseEntity<ApiResponse<String>> addSosUpdate(
            ...
            @RequestBody com.example.GuardBatXat.dto.request.rescue.SosUpdateLogRequest request) {
        String identifier = SecurityContextHolder.getContext().getAuthentication().getName();
